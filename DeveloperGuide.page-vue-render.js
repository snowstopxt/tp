...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Stores the HireMe application data")]),_v(", which includes all "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("InternshipApplication")]),_v(" objects (contained in a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniqueList<InternshipApplication>")]),_v(" object).")]),_v(" "),_c('li',[_c('strong',[_v("Manages a filtered list")]),_v(" of currently 'selected' "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("InternshipApplication")]),_v(" objects (e.g., search results) as a separate "),_c('em',[_v("filtered")]),_v(" list, exposed as an unmodifiable "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ObservableList<InternshipApplication>")]),_v(". This allows the UI to automatically update when the data changes, as the list is 'observable'.")]),_v(" "),_c('li',[_c('strong',[_v("Stores a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UserPrefs")]),_v(" object")]),_v(", which represents the user’s preferences. This is exposed externally as a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ReadOnlyUserPrefs")]),_v(" object.")]),_v(" "),_c('li',[_c('strong',[_v("Is self-contained")]),_v(", meaning the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" does not depend on any other components (as it represents the domain entities, which should be logically independent).")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Refer to AddSequenceDiagram for how "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" creates FilterCommandParser and FilterCommand.\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FilterCommandParser")]),_v(" obtains the specified status value and ensures that it is valid.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The implementation of the command command follows the convention of a normal command, where "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" is responsible for parsing the user input string into an executable command.\nIn this case, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" creates "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommandParser")]),_v(" to parse user input string.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sun, 27 Oct 2024, 15:24:47 GMT+8]")])])])}
}];
